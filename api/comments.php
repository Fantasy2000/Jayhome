...
function handleThreads($db) {
    ...
    // 获取总数
    $countSql = "SELECT COUNT(*) as total FROM comments WHERE $whereTop";
    $countStmt = $db->query($countSql);
    $total = $countStmt->fetch()['total'];
    $totalPages = (int)ceil($total / $limit);
    
    $sqlTop = "SELECT $fields FROM comments WHERE $whereTop ORDER BY created_at DESC, id DESC LIMIT :limit OFFSET :offset";
