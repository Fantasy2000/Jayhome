...
<body>
    <div class="admin-header">
        ...
        <div class="admin-user">
            ...
            <a href="change_password.php" class="logout-btn" style="text-decoration: none; display: inline-block;">修改密码</a>
            <a href="settings-manager.php" class="logout-btn" style="text-decoration: none; display: inline-block;">网站设置</a>
        ...
        <div id="comments-tab" class="tab-content active">
            ...
            <div class="toolbar">
                ...
                <div style="display:flex; gap:10px; align-items:center;">
                    ...
                    <button class="add-btn" style="background:#ef4444" onclick="batchDeleteComments()">批量删除</button>
    ...
    <script>
        ...
        function displayComments(comments) {
            ...
            let html = '<div class="table-container"><table><thead><tr><th><input type="checkbox" id="selectAllComments" onclick="toggleSelectAllComments()"></th><th>ID</th><th>评论内容</th><th>点赞数</th><th>IP地址</th><th>创建时间</th><th>操作</th></tr></thead><tbody>';
        ...
        async function batchDeleteComments() {
            ...
            if (!confirm(`确定要删除选中的 ${ids.length} 条评论吗？`)) return;
            
            try {
                const response = await fetch('../api/comments.php?action=batch_delete', {
                    method: 'POST',
